...
require (
	github.com/d7561985/tel/example/demo/client/v2 v2.0.0-20220615105446-570c78970e9d
...
require (
	...
	github.com/d7561985/tel/middleware/grpc/v2 v2.0.0-20220615105446-570c78970e9d // indirect
